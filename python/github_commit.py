...
@file: github_commit.py
@time: 2017/5/25 22:11
"""

from github import Github
from github_info import EmployCommit
from github_info import EmployIssue
import datetime
...
while True:
    ...
    '''
    func_command = input('please enter command')
