...
def get_content(page=2):
    ...
    url ='http://sou.zhaopin.com/jobs/searchresult.ashx?jl=%e5%85%a8%e5%9b%bd&kw=python&sm=0&source=0&sg=c131af6ec2c74dfba41100e1c8925118&p='+str(page)+'.html'
...
fo = open('python_job_zl.csv', 'w', encoding='utf-8')
