...
# http://sou.zhaopin.com/jobs/searchresult.ashx?jl=%E5%85%A8%E5%9B%BD&kw=%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0&isadv=0&sg=7cde5109fcc247beaf99fe7b199e57a3&p=60

def get_content(page):
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0 ', 'host':'img01.zhaopin.cn'}  # 模拟浏览器
    url ='http://sou.zhaopin.com/jobs/searchresult.ashx?jl=%E5%85%A8%E5%9B%BD&kw=%E6%9C%BA%E5%99%A8%E5%AD%A6%E4%B9%A0&isadv=0&sg=7cde5109fcc247beaf99fe7b199e57a3&p='+str(page)+'.html'
...
fo = open('ml_job_zl1.csv', 'w', encoding='utf-8')
fo.write('岗位')
fo.write(',')
fo.write('公司')
fo.write(',')
