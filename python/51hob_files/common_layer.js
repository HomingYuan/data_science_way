...
$.extend({
    commonLayer:
    {
        ...
        {
            var sContent = '<h2 id="' + oSettings.top + '">' + '<p id="' + oSettings.top_message + '">' + lang[oSettings.data_type]['layer_select'];
        ...
        getSubContent: function (oSettings, aSub, oJqueryElement, iSelect)  //获取小类内容
        {
            ...
            sContent += '<tr class="' + oSettings.center_right_list_sub_category + '" id="' + oSettings.center_right_list_sub_category + '_' + iNavigationId + '_' + iSelect + '">' + 
                            '<td colspan="' + oSettings.data_row_num + '"><div class="in d0"><font style="left:' + jQuery.commonLayer.getArrowPosition(oJqueryElement) + 'px"></font><div><span><em id="' + oSettings.center_right_list_sub_category_each + '_' + iNavigationId + '_' + iSelect + '" class="' + sSelectedClass + ' ' + oSettings.center_right_list_sub_category_each_all + '" data-value="' + iSelect + '" data-navigation="' + iNavigationId + '">' + lang['layer']['all'] + '</em></span>';
